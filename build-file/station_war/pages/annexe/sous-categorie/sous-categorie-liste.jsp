...
<% try{ 
    ...
    pr.setApres("annexe/sous-categorie/sous-categorie-liste.jsp");
    ...
    String lienTableau[] = {pr.getLien() + "?but=annexe/sous-categorie/sous-categorie-fiche.jsp"};
