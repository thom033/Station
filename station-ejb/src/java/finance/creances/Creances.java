...
public class Creances extends FinanceSignature {
    ...
    public ComptaSousEcriture[] getSousEcriture(Date dateMin, Date dateMax, Connection connection) throws Exception {
        String apresWhere = " and (daty <= TO_DATE('"+dateMax.toString()+"','YYYY-MM-dd') and daty >= TO_DATE('"+dateMin.toString()+"','YYYY-MM-dd')) and compte like '411% and compte not like 411012'";
