<%-- 
    Document   : point-modif
    Created on : 22 mars 2024, 09:26:52
    Author     : Angela
--%>
            ...
            <div class="box-fiche">
                <div class="box">
                    <div class="box-title with-border">
                        <h1 class="box-title"><a href=<%= lien + "?but=annexe/point/point-fiche.jsp&id="+id%> <i class="fa fa-arrow-circle-left"></i></a><%=pu.getTitre()%></h1>
                    </div>
